...
public class ServerManager extends BroadcastReceiver {
    ...
    private static final String ACTION = "com.liuh.landserver.receiver";
    ...
    public ServerManager(MainActivity mActivity) {
        this.mActivity = mActivity;
        mService = new Intent(mActivity, CoreService.class);
    }
